                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <form class="form" data-parsley-validate method="POST"
                                          action="{{ route('answers.store') }}" enctype="multipart/form-data">
                                        @csrf
                                        @method('POST')
                                        <div class="row">
                                            <div class="col-md-12 col-12">
                                                <div class="form-group mandatory">
                                                    ...
                                                    <select class="choices form-select" name="question_id" data-parsley-required="true">
